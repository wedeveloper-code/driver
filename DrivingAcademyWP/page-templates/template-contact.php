                    ...
                    <form id="daw-contact-form" class="cta-form" novalidate>
                        ...
                        <div class="form-group">
                            ...
                            <select id="cf-subject" name="subject" class="form-input">
                                ...
                                <option value="fiber-optics"><?php esc_html_e('Fiber Optics Training', 'drivingacademywp'); ?></option>
                                <option value="osha"><?php esc_html_e('OSHA / Hazmat / Surface Mining', 'drivingacademywp'); ?></option>
